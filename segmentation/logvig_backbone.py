...
if has_mmseg:
    ...
    def logvig_s_feat(pretrained=True, **kwargs):
        model = LogViG(blocks=[[5,5], [5,5], [15,5], [5,5]],
                        ...
                        num_classes=1000,
                        out_indices=[0, 1, 2, 3],
                        pretrained='../Results/S_LogViG/S_LogViG.pth')
        model.default_cfg = default_cfgs['logvig']
        return model

    @seg_BACKBONES.register_module()
    def logvig_b_feat(pretrained=True, **kwargs):
        model = LogViG(blocks=[[5,5], [5,5], [15,5], [5,5]],
                        ...
                        num_classes=1000,
                        out_indices=[0, 1, 2, 3],
                        pretrained='../Results/B_LogViG/B_LogViG.pth')
        model.default_cfg = default_cfgs['logvig']
        return model
